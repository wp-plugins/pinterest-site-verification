...
Plugin URI: http://wphelpline.com/Pinterest-site-verification-using-meta-tag
    ...
    <div class="icon32" id="icon-options-general"><br /></div>
		...
		<form name="form1" id="form1" method="post" action="options.php">
			...
			<p style="font-size:0.95em"><?php 
				_e( sprintf( 'You may post a comment on this plugin\'s %1$shomepage%2$s if you have any questions, bug reports, or feature suggestions.', '<a target="_blank" href="http://wphelpline.com/Pinterest-site-verification-using-meta-tag" rel="help">', '</a>' ) ); ?></p>
			...
			<table class="form-table" style="margin-left:30px;">
				...
				<tr>
					...
					<td>
						<p>"meta name=p:domain_verify content="<span style="color:red">XXXXXXXXXXXXXXXXX</span>"</p> (Copy the content from Pinterest verification tag.)
					</td>
				
				</tr>
            	<tr valign="top"><th scope="row"><label for="Pinterest_head_tag_verification_item[account]"><?php _e( 'Pinterest Meta Tag Content' ); ?>: </label></th>
					<td>
						<input type="text" name="Pinterest_head_tag_verification_item[account]" value="<?php echo $options['account']; ?>" style="width:200px;" maxlength="400"/>
	            	</td>
				</tr>
...
<meta name="p:domain_verify" content="' . $options['account'] . '"/>';
